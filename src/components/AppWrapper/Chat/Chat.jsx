...
export default function Chat({
    messages, setMessages, pub, sub, user, channel, getLatestData, sendChatAnnouncement 
  }) {
    ...
    pubnub.addListener({
      ...
      message: function(msg) {
        ...
        if(msg.message.text && !newSignIn){
          ...
          if (substringInString(newMessage, " have updated pick ") || substringInString(newMessage, " have drafted ")) {
    ...
    pubnub.hereNow({
      ...
      if (status.statusCode === 200) {
        ...
        currentUsers.forEach(currentUser => {
          if (currentUser.uuid !== "announcement" && !substringInString(currentUsers.uuid, 'pn-')) {
